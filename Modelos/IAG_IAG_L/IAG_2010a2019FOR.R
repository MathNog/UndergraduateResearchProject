...
setwd("C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L")
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/AdjClose_IAG_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/LogRet_IAG_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/Serie_IAG_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/ACF_IAG_10a19.jpeg",width = 658, height = 553)
Acf(serie_ts_2fit,main='ACF for Log Return AdjClose IAG 2010-2019')#lags relevantes para MA(q) -> 1, 11 e 24
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/PACF_IAG_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/Res(1,0,0)_IAG_10a19.jpeg",width = 658, height = 553)
checkresiduals(fit100)
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/Res(11,0,24)_IAG_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/For(1,0,0)_IAG_10a19.jpeg",width = 658, height = 553)
plot(for100)
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/For(11,0,24)_IAG_10a19.jpeg",width = 658, height = 553)
plot(for11024)
dev.off()


#All entries
forecast_values=for11024$mean
...
plot=ggplot(seriesDF,aes(x=c(1:length(forecast_values))))+
  ggtitle("Forecast Comparison (all) IAG") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/ForecastAll_IAG.jpeg",width = 658, height = 553)
print(plot)
dev.off()
...
plot=ggplot(seriesDF,aes(x=c(1:50)))+
  ggtitle("Forecast Comparison (50 first) IAG") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/Forecast50first_IAG.jpeg",width = 658, height = 553)
print(plot)
dev.off()
...
serie_2for=serie[c(2496:length(serie))]
serie_ts_2fit=ts(serie_2fit)
serie_ts_2for=ts(serie_2for)

fit11024=arima(serie_ts_2fit, order = c(11,0,24))

for11024=forecast(fit11024,h=20,level=c(80,95))
...
plot=ggplot(seriesDF,aes(x=c(1:length(forecast_values))))+
  ggtitle("Forecast Comparison (20 last) IAG") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/IAG_IAG_L/Dados_10a19FOR/Forecast20last_IAG.jpeg",width = 658, height = 553)
print(plot)
dev.off()
