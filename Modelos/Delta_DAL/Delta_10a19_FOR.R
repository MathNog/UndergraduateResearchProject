...
setwd("C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL")
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/AdjClose_Delta_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/LogRet_Delta_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/Serie_Delta_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/ACF_Delta_10a19.jpeg",width = 658, height = 553)
Acf(serie_ts_2fit,main='ACF for Log Return AdjClose Delta 2010-2019')#lags relevantes para MA(q) -> 4,14,16
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/PACF_Delta_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/Res(4,0,4)_Delta_10a19.jpeg",width = 658, height = 553)
checkresiduals(fit404)
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/Res(0,0,4)_Delta_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/For(4,0,4)_Delta_10a19.jpeg",width = 658, height = 553)
plot(for404)
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/For(0,0,4)_Delta_10a19.jpeg",width = 658, height = 553)
plot(for004)
dev.off()


#All entries
forecast_values=for004$mean
...
plot=ggplot(seriesDF,aes(x=c(1:length(forecast_values))))+
  ggtitle("Forecast Comparison (all) Delta") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/ForecastAll_Delta.jpeg",width = 658, height = 553)
print(plot)
dev.off()
...
plot=ggplot(seriesDF,aes(x=c(1:50)))+
  ggtitle("Forecast Comparison (50 first) Delta") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/Forecast50first_Delta.jpeg",width = 658, height = 553)
print(plot)
dev.off()
...
for004=forecast(fit004,h=20,level=c(80,95))
...
plot=ggplot(seriesDF,aes(x=c(1:length(forecast_values))))+
  ggtitle("Forecast Comparison (20 last) Delta") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/Delta_DAL/Dados_10a19FOR/Forecast20last_Delta.jpeg",width = 658, height = 553)
print(plot)
dev.off()
