...
setwd("C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK")
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/AdjClose_ChinaEastern_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/LogRet_ChinaEastern_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/Serie_ChinaEastern_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/ACF_ChinaEastern_10a19.jpeg",width = 658, height = 553)
Acf(serie_ts_2fit,main='ACF for Log Return AdjClose ChinaEastern 2010-2019')#lags relevantes para MA(q) -> 1, 10 e 16
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/PACF_ChinaEastern_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/Res(0,0,1)_ChinaEastern_10a19.jpeg",width = 658, height = 553)
checkresiduals(fit001)
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/Res(10,0,16)_ChinaEastern_10a19.jpeg",width = 658, height = 553)
...
jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/For(0,0,1)_ChinaEastern_10a19.jpeg",width = 658, height = 553)
plot(for001)
dev.off()

jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/For(10,0,16)_ChinaEastern_10a19.jpeg",width = 658, height = 553)
plot(for10016)
dev.off()


#All entries
forecast_values=for10016$mean
...
plot=ggplot(seriesDF,aes(x=c(1:length(forecast_values))))+
  ggtitle("Forecast Comparison (all) ChinaEast") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/ForecastAll_AirFranceKLM.jpeg",width = 658, height = 553)
print(plot)
dev.off()
...
plot=ggplot(seriesDF,aes(x=c(1:50)))+
  ggtitle("Forecast Comparison (50 first) ChinaEast") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/Forecast50first_AirFranceKLM.jpeg",width = 658, height = 553)
print(plot)
dev.off()
...
#New split
#Separando a serie em uma parte para ajuste do modelo e outra para comparação com previsão
serie_2fit=serie[c(1:2438)]
serie_2for=serie[c(2439:length(serie))]
serie_ts_2fit=ts(serie_2fit)
serie_ts_2for=ts(serie_2for)

fit10016=arima(serie_ts_2fit, order = c(10,0,16))

for10016=forecast(fit10016,h=20,level=c(80,95))
...
plot=ggplot(seriesDF,aes(x=c(1:length(forecast_values))))+
  ggtitle("Forecast Comparison (20 last) ChinaEast") + 
  geom_line(aes(y = original, colour = "original")) + 
  geom_line(aes(y = forecasted, colour = "predicted"))


jpeg(file="C:/Users/matno_5/OneDrive/Área de Trabalho/PUC/IC/GitPrivado/IC/Modelos/ChinaEastern_0670_HK/Dados_10a19FOR/Forecast20last_AirFranceKLM.jpeg",width = 658, height = 553)
print(plot)
dev.off()
